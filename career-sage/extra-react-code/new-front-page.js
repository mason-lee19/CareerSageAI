  ...
  return (
    <div id="webcrumbs">
      <div className="w-[1200px] rounded-lg shadow-lg bg-white min-h-[2000px] text-neutral-950 font-sans">
        <header className="sticky top-0 bg-white z-10 shadow-md">
          <nav className="flex justify-between items-center p-6">
            ...
            <ul className="flex gap-6 text-neutral-950">
              <li>
                <a href="#hero" className="hover:text-primary-500">
                  Home
                </a>
              </li>
              <li>
        ...
        <section
          id="hero"
          className="h-[800px] relative flex items-center justify-center text-center text-neutral-50"
        >
          <div
            className="absolute inset-0 bg-cover"
            style={{
              backgroundImage: `url('https://tools-api.webcrumbs.org/image-placeholder/1200/800/job/search')`,
            }}
          ></div>
          ...
          <div className="grid grid-cols-3 gap-8">
            <div className="text-center">
              <div className="h-[200px] w-[200px] bg-neutral-200 rounded-md mx-auto mb-4 flex items-center justify-center">
                <span className="material-symbols-outlined text-primary-500 text-6xl">
                  account_circle
                </span>
              </div>
        ...
        <section id="faq" className="py-16 bg-neutral-100">
          ...
          <details className="mb-4">
            ...
            <p className="ml-4 mt-2">
              Our algorithm quantifies the similarity between your resume and
              job descriptions to generate a score.
            </p>
          </details>
          <details className="mb-4">
            <summary className="font-semibold cursor-pointer">
              Which job sites are included?
            </summary>
            <p className="ml-4 mt-2">
              We aggregate postings from top job sites to provide you with the
              best opportunities.
            </p>
          </details>
        </section>
        ...
        <footer className="py-8 bg-neutral-200">
          ...
          <div className="flex justify-center mt-4">
            <a href="#" className="text-primary-500 text-xl mx-2">
