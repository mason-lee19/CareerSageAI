...
export const MyPlugin = () => {
  return (
    <div id="webcrumbs"> 
                	<div className="w-[800px] bg-white rounded-lg shadow-lg min-h-[600px]">  {/* Navigation Bar */}
    	...
    	<a href="#" className="text-white">Interview Prep</a>
    	...
    	<a href="#" className="text-white">Sign in</a>
    	  ...
    	  <footer className="w-full h-[60px] bg-neutral-900 flex justify-center items-center">
    	    <p className="text-white text-sm">© 2024 CareerSage. All Rights Reserved.</p>
    	  </footer>
    	</div> 
                </div>
  )
